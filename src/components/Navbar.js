...
<div className="d-flex">
  ...
  <div className="bg-dark rounded mx-2" style={{height:'30px',width:'30px',cursor:'pointer',borderWidth:'5px',borderStyle:'solid',borderColor:'#000'}} onClick={()=>{props.toggleMode('dark')}}></div>
  <div className="bg-light rounded mx-2" style={{height:'30px',width:'30px',cursor:'pointer',borderWidth:'5px',borderStyle:'solid',borderColor:'brown'}} onClick={()=>{props.toggleMode('light')}}></div>
</div>
